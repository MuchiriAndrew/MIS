...
public class ind_penalties extends javax.swing.JFrame {

    /**
     * Creates new form ind_penalties
     */
    public ind_penalties() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("INDIVIDUAL PENALTIES FOR DEFAULTED PAYMENTS");
        ...
        getContentPane().add(memname, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 170, 150, 22));

        transtype.setForeground(new java.awt.Color(0, 0, 0));
        transtype.setText("PEN");
        getContentPane().add(transtype, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 90, 150, -1));
        ...
        getContentPane().add(memid, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 130, 150, -1));
        ...
        getContentPane().add(date, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 280, 150, -1));
        ...
        getContentPane().add(timeamt, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 210, 150, -1));

        amt.setForeground(new java.awt.Color(255, 255, 255));
        getContentPane().add(amt, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 250, 150, 16));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        pstmt.setDouble(4,Double.parseDouble(amt.getText()));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ind_penalties.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ind_penalties().setVisible(true);
            }
        });
    }
